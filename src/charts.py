...
def _polish(figure: go.Figure) -> go.Figure:
    ...
    figure.update_layout(
        ...
        margin={"t": 56, "r": 24, "l": 56, "b": 70},
        hoverlabel={"font": {"family": FONT["family"], "size": 12}, "bordercolor": "#ffffff"},
    )
    figure.update_xaxes(gridcolor=GRID_COLOR, zerolinecolor=GRID_COLOR, linecolor="#e2e8f0")
    figure.update_yaxes(gridcolor=GRID_COLOR, zerolinecolor=GRID_COLOR, linecolor="#e2e8f0")
    return figure
