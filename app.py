...
def apply_style() -> None:
    st.markdown(
        ...
        .gold-rain .gold-bar .gold-solid {
            ...
            animation:goldBarSpin var(--duration) cubic-bezier(.35,.05,.65,.95) infinite; animation-delay:var(--delay);
        }
        ...
        @keyframes goldBarFall {
            0% { opacity:0; transform:translate3d(0,-13vh,0) scale3d(var(--scale),var(--scale),var(--scale)); }
            9% { opacity:.72; }
            46% { transform:translate3d(var(--drift),47vh,0) scale3d(var(--scale),var(--scale),var(--scale)); }
            72% { transform:translate3d(0,77vh,0) scale3d(var(--scale),var(--scale),var(--scale)); }
            88% { opacity:.62; }
            100% { opacity:0; transform:translate3d(var(--drift),113vh,0) scale3d(var(--scale),var(--scale),var(--scale)); }
        }
        @keyframes goldBarSpin {
            0% { transform:perspective(900px) rotateX(28deg) rotateY(-22deg) rotateZ(-10deg); }
            46% { transform:perspective(900px) rotateX(188deg) rotateY(148deg) rotateZ(68deg); }
            72% { transform:perspective(900px) rotateX(292deg) rotateY(254deg) rotateZ(138deg); }
            100% { transform:perspective(900px) rotateX(414deg) rotateY(378deg) rotateZ(214deg); }
        }
        @keyframes barGleam {
