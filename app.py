...
def apply_style() -> None:
    st.markdown(
        ...
        .gold-rain .gold-bar {
            position:absolute; top:-11vh; left:var(--left); width:calc(54px * var(--scale)); height:calc(34px * var(--scale));
            opacity:0; transform-style:preserve-3d; will-change:transform,opacity; perspective:700px;
            filter:drop-shadow(0 7px 7px rgba(73,46,0,.25)) drop-shadow(0 0 8px rgba(255,199,38,.10));
            animation:goldBarFall var(--duration) cubic-bezier(.35,.05,.65,.95) infinite; animation-delay:var(--delay);
        }
        ...
        .gold-rain .gold-bar .bar-top {
            left:9%; top:0; width:82%; height:63%;
            clip-path:polygon(17% 0,83% 0,100% 100%,0 100%);
            background:linear-gradient(135deg,#fffbd0 0%,#ffe879 13%,#ffc927 34%,#f5b514 55%,#ffd84b 77%,#bd7903 100%);
            box-shadow:inset 0 2px 3px rgba(255,255,232,.92),inset 0 -4px 5px rgba(145,84,0,.22);
        }
        ...
        .gold-rain .gold-bar .bar-front {
            left:9%; bottom:0; width:82%; height:49%;
            clip-path:polygon(0 0,100% 0,88% 100%,12% 100%);
            background:linear-gradient(180deg,#e9aa0c 0%,#bd7903 42%,#8e5700 100%);
            box-shadow:inset 0 2px 2px rgba(255,221,93,.42),inset 0 -3px 4px rgba(85,47,0,.38);
        }
        .gold-rain .gold-bar .bar-left {
            left:0; bottom:0; width:18%; height:49%;
            clip-path:polygon(50% 0,100% 0,76% 100%,0 100%);
            background:linear-gradient(145deg,#d69306,#754300 82%);
        }
        .gold-rain .gold-bar .bar-right {
            right:0; bottom:0; width:18%; height:49%;
            clip-path:polygon(0 0,50% 0,100% 100%,24% 100%);
            background:linear-gradient(215deg,#ffc638,#8b5200 78%);
        }
        .gold-rain .gold-bar .bar-stamp {
            position:absolute; z-index:3; left:20%; right:20%; top:18%; text-align:center;
            color:#8a5500 !important; font-family:Georgia,serif; font-size:calc(7px * var(--scale)); font-weight:900;
            letter-spacing:.10em; line-height:1; text-shadow:0 1px 0 rgba(255,247,177,.90); opacity:.82;
        }
        ...
        @keyframes goldBarFall {
            0% { opacity:0; transform:perspective(700px) translate3d(0,-13vh,0) rotateX(32deg) rotateY(-18deg) rotateZ(-12deg); }
            9% { opacity:.62; }
            46% { transform:perspective(700px) translate3d(var(--drift),47vh,0) rotateX(205deg) rotateY(168deg) rotateZ(82deg); }
            72% { transform:perspective(700px) translate3d(0,77vh,0) rotateX(318deg) rotateY(278deg) rotateZ(154deg); }
            88% { opacity:.54; }
            100% { opacity:0; transform:perspective(700px) translate3d(var(--drift),113vh,0) rotateX(455deg) rotateY(405deg) rotateZ(228deg); }
        }
        @keyframes barGleam {
        ...
        <div class="gold-rain" aria-hidden="true">
          <span class="gold-bar" style="--left:20%;--delay:-3s;--duration:21s;--scale:.82;--drift:34px;--gleam:-1s"><i class="bar-top"></i><i class="bar-front"></i><i class="bar-left"></i><i class="bar-right"></i><b class="bar-stamp">GOLD</b></span>
          <span class="gold-bar" style="--left:31%;--delay:-15s;--duration:26s;--scale:.64;--drift:-42px;--gleam:-3s"><i class="bar-top"></i><i class="bar-front"></i><i class="bar-left"></i><i class="bar-right"></i><b class="bar-stamp">GOLD</b></span>
          <span class="gold-bar" style="--left:42%;--delay:-8s;--duration:23s;--scale:1.00;--drift:48px;--gleam:-2s"><i class="bar-top"></i><i class="bar-front"></i><i class="bar-left"></i><i class="bar-right"></i><b class="bar-stamp">GOLD</b></span>
          <span class="gold-bar" style="--left:54%;--delay:-21s;--duration:29s;--scale:.68;--drift:-28px;--gleam:-4s"><i class="bar-top"></i><i class="bar-front"></i><i class="bar-left"></i><i class="bar-right"></i><b class="bar-stamp">GOLD</b></span>
          <span class="gold-bar" style="--left:66%;--delay:-11s;--duration:24s;--scale:.78;--drift:40px;--gleam:-.5s"><i class="bar-top"></i><i class="bar-front"></i><i class="bar-left"></i><i class="bar-right"></i><b class="bar-stamp">GOLD</b></span>
          <span class="gold-bar" style="--left:77%;--delay:-1s;--duration:27s;--scale:.60;--drift:-36px;--gleam:-2.5s"><i class="bar-top"></i><i class="bar-front"></i><i class="bar-left"></i><i class="bar-right"></i><b class="bar-stamp">GOLD</b></span>
          <span class="gold-bar" style="--left:87%;--delay:-18s;--duration:28s;--scale:.88;--drift:44px;--gleam:-3.5s"><i class="bar-top"></i><i class="bar-front"></i><i class="bar-left"></i><i class="bar-right"></i><b class="bar-stamp">GOLD</b></span>
          <span class="gold-bar" style="--left:96%;--delay:-6s;--duration:24s;--scale:.66;--drift:-24px;--gleam:-1.5s"><i class="bar-top"></i><i class="bar-front"></i><i class="bar-left"></i><i class="bar-right"></i><b class="bar-stamp">GOLD</b></span>
        </div>
        """,
