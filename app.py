...
def apply_style() -> None:
    st.markdown(
        ...
        .overview-kpi .kpi-icon { display:flex; align-items:center; justify-content:center; width:2rem; height:2rem; border-radius:9px;
            background:#eff6ff; color:var(--kpi-accent,#1d4ed8) !important; font-size:.8rem; font-weight:900; }
