    ...
    st.markdown(
        ...
        <div class="forecast-result">
          <div class="result-header">
            <div>
              <div class="result-eyebrow">Forecast generated · Direct H1 prediction</div>
              <div class="result-title">{best_model} Forecast Snapshot</div>
              <div class="result-copy">Official Evaluation winner · Each horizon is predicted directly, not recursively.</div>
            </div>
            <div class="result-model-badge">
              <div class="badge-star">★</div>
              <div><div class="badge-label">Best overall model</div><div class="badge-value">{best_model}</div></div>
            </div>
          </div>
